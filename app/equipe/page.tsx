...
const teamMembers = [
  {
    name: "Jean Dupont",
    role: "CEO & Fondateur",
    description: "Jean est passionné par l'innovation et la gestion d'entreprise. Il a fondé l'entreprise en 2010.",
  ...
  },
  {
    ...
    description: "Marie est une experte en développement logiciel et en gestion de projets techniques.",
  ...
  },
  {
    ...
    description: "Ahmed est spécialisé dans les technologies modernes comme Next.js, React et Node.js.",
